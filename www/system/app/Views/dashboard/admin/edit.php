...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-3">
    ...
    <fieldset class="border rounded-3 px-2 py-0 mb-3">
        ...
        <div class="form-floating mb-2">
            <input type="text" class="form-control rounded-3 <?= (validation_show_error('fullname')) ? 'is-invalid' : ''; ?>" id="fullname" name="fullname" value="<?= (old('fullname')) ? old('fullname') : $admin['fullname']; ?>" autocomplete="off" dir="auto" placeholder="fullname">
        ...
        <div class="form-floating mb-2">
            <input type="text" class="form-control rounded-3 <?= (validation_show_error('username')) ? 'is-invalid' : ''; ?>" id="username" name="username" value="<?= (old('username')) ? old('username') : $admin['username']; ?>" autocomplete="off" dir="auto" placeholder="username">
        ...
        <div class="form-floating mb-2">
            <select class="form-select rounded-3 <?= (validation_show_error('role')) ? 'is-invalid' : ''; ?>" id="role" name="role" aria-label="role">
                ...
                <option value="Master Admin" <?= (old('role')) ? ((old('role') == 'Master Admin') ? 'selected' : '') : (($admin['role'] == 'Master Admin') ? 'selected' : ''); ?>>Master Admin</option>
                <option value="Admin" <?= (old('role')) ? ((old('role') == 'Admin') ? 'selected' : '') : (($admin['role'] == 'Admin') ? 'selected' : ''); ?>>Admin</option>
            </select>
