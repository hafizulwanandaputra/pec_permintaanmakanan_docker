        ...
        <table id="tabel" class="table table-sm table-hover" style="width:100%; font-size: 9pt;">
            <thead>
                <tr class="align-middle">
                    ...
                    <th scope="col" class="bg-body-secondary border-secondary text-nowrap" style="border-bottom-width: 2px;">Waktu dan Tanggal<br>(UTC)</th>
                    ...
                    <th scope="col" class="bg-body-secondary border-secondary" style="border-bottom-width: 2px; min-width: 128px;">Aktivitas</th>
                    <th scope="col" class="bg-body-secondary border-secondary" style="border-bottom-width: 2px;">Sistem Operasi</th>
                    <th scope="col" class="bg-body-secondary border-secondary" style="border-bottom-width: 2px;">Web Browser</th>
                    <th scope="col" class="bg-body-secondary border-secondary" style="border-bottom-width: 2px;">Telepon Seluler</th>
                    <th scope="col" class="bg-body-secondary border-secondary" style="border-bottom-width: 2px; min-width: 128px;">User Agent</th>
                </tr>
            </thead>
...
- below function makes the datatable to export all records when "server side processing" is on */
    ...
    $(document).ready(function() {
        $('#tabel').DataTable({
            "oLanguage": {
                "sDecimal": ",",
                "sEmptyTable": 'Tidak ada riwayat aktivitas.',
                "sInfo": "Menampilkan _START_ hingga _END_ dari _TOTAL_ riwayat aktivitas",
                "sInfoEmpty": "Menampilkan 0 hingga 0 dari 0 riwayat aktivitas",
                "sInfoFiltered": "(di-filter dari _MAX_ riwayat aktivitas)",
                "sInfoPostFix": "",
                "sThousands": ".",
                "sLengthMenu": "Tampilkan _MENU_ riwayat aktivitas",
                "sLoadingRecords": "Memuat...",
                "sProcessing": "",
                "sSearch": "Cari:",
                "sZeroRecords": "Riwayat aktivitas yang Anda cari tidak ditemukan",
                "oAria": {
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('/settings/activitieslist') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "target": [0],
