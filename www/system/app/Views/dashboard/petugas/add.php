...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-3">
    <?= form_open_multipart('/petugas/create'); ?>
    <?= csrf_field(); ?>
    <fieldset class="border rounded-3 px-2 py-0 mb-3">
        ...
        <div class="form-floating mb-2">
            <input type="text" class="form-control rounded-3 <?= (validation_show_error('nama_petugas')) ? 'is-invalid' : ''; ?>" id="nama_petugas" name="nama_petugas" value="<?= old('nama_petugas'); ?>" autocomplete="off" dir="auto" placeholder="nama_petugas">
