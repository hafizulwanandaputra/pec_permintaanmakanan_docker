...
<div class="d-flex justify-content-start align-items-center">
    ...
    <div>
        ...
        <div style="font-size: 8pt;">Menu: <?= $menu['nama_menu'] ?></div>
    </div>
</div>
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-3">
    <?= form_open_multipart('/menu/createpermintaan/' . $menu['id_menu']); ?>
    <?= csrf_field(); ?>
    <fieldset class="border rounded-3 px-2 py-0 mb-3">
        ...
        <div class="form-floating mb-2">
            <select class="form-select rounded-3" id="menu" name="menu" aria-label="menu" disabled>
                <option value="<?= $menu['id_menu']; ?>" selected><?= $menu['tanggal'] . ' - ' . $menu['nama_menu'] . ' - ' . $menu['nama_petugas']; ?></option>
            </select>
