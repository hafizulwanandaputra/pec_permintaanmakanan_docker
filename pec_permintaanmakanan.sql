...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Agu 2024 pada 08.53
...
--
CREATE DATABASE IF NOT EXISTS `pec_permintaanmakanan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pec_permintaanmakanan`;
